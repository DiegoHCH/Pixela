...
const en: typeof es = {
  ...
  'bar.print': 'Print',
  'bar.printNow': 'Print now',
  'print.hint': 'One sheet per board, one letter per colour. Black and white on purpose: the app\'s dark background would eat your ink, and on paper you assemble by reading letters.',
  'print.board': 'Board {n} of {total}',
  'print.range': 'Columns {c1}–{c2} · rows {r1}–{r2}',
  'print.beads': '{n} beads',
  'print.legend': 'Legend',
